...
window.cancelAnimationFrame = window.cancelAnimationFrame || window.webkitCancelAnimationFrame || window.mozCancelAnimationFrame || window.msCancelAnimationFrame || function (e) {
    clearTimeout(e)
};
...
(function (r) {
    ...
    r.trackEvent = function (e, A, t, i) {
        if (window.ga && !r.isDebug) {
            ga("send", "event", e, A, t, i ? 1 : undefined, {
                nonInteraction: i
            })
        } else {
    ...
    function p(e) {
        ...
        r.Camera.getCamera(function (e, A, t) {
            if (t) {
                r.error(t, A);
                return
            }
    ...
    $(document).ready(function () {
        ...
        setTimeout(function () {
            ...
            var A = !window.adsbygoogle || !window.adsbygoogle.loaded || $("#banner ins").length < 2;
            if (A) {
                $("#banner>div").prepend('<a href="https://neave.com/" target="_top"><div class="adblock">Neave Interactive</div></a>')
            }
            r.trackEvent("Capabilities", "AdBlock", A.toString(), true)
        }, 2500)
    })
})(WebcamToy);
(function (n) {
...
WebcamToy.Services = function (o) {
    ...
    function g(e) {
        ...
        try {
            if (!!window.DataView) {
                return new Blob([new DataView(i)], {
                    type: t
                })
            }
        } catch (e) {}
...
WebcamToy.Texture = function () {
    ...
    e.prototype.toImage = function (e, A, t, i) {
        ...
        var r = 2,
            ...
            h = g(this, t, i),
            u = g(this, o, s),
            l, f, d = "data:image/gif;base64,R0lGODdhAQABAPAAAP///wAAACwAAAAAAQABAAACAkQBADs=";
        try {
...
WebcamToy.Effect = function (u) {
    ...
    var t = ["mirrorleft", "mirrorright", "mirrortop", "mirrorbottom", "mirrorquad", "upsidedown", "switch", "kaleidoscope", "fragment", "quadcam", "splitscreen", "filmstrip", "ghost", "colorghost", "trail", "shuffle", "tunnel", "spiral", "twist", "dent", "pinch", "bulge", "fisheye", "wedge", "ripple", "stretch", "softfocus", "hazydays", "vintage", "rose", "retro", "cocoa", "xpro", "envy", "zinc", "citrus", "berry", "mint", "smoke", "halo", "bloom", "glaze", "watercolor", "silk", "oldmovie", "cocktail", "spycam", "hotpink", "bokeh", "flare", "danger", "rainbow", "trueblue", "mono", "lomo", "comicbook", "monoquad", "lomoquad", "comicstrip", "magazine", "blackwhite", "cartoon", "outline", "sketch", "crosshatch", "underwater", "fire", "snow", "disco", "sparkle", "glitch", "xray", "lsd", "alien", "nightvision", "thermal", "spectrum", "neon", "popart", "popbooth"],
        ...
        c = {
            ...
            bloom: function () {
                this.uniforms = {
                    center: this.center,
                    radius: (this.isSquare ? this.height : this.width) / 4,
                    width: this.height
                }
            },
            bokeh: function () {
                ...
                this.uniforms = {
                    ...
                    radialblur1: {
                        texSize: this.size,
                        center: this.center,
                        blur: Math.floor(this.maxLength / 32),
                        radius: e,
                        width: A,
            ...
            cartoon: function () {
                ...
                this.uniforms = {
                    cartoonink: {
                        size: [2.5 / x.size.height * this.height / this.width, 2.5 / x.size.height]
                    },
                    cartoon: {
                        rect: this.getRect(.01)
                    }
                }
            },
            cocktail: function () {
                ...
                this.uniforms = {
                    rect: this.getRect(.006),
                    fade: x.size.width / 3,
                    rotate: v && this.size[0] === this.width ? 1 : 0
                }
            },
            cocoa: function () {
                ...
                this.uniforms = {
                    center: this.center,
                    radius: (this.isSquare ? this.height : this.width) / 6,
                    width: this.minLength * .58,
                    rect: this.getRect(.022),
                    fade: 60
                }
            },
            colorghost: function () {
            ...
            comicbook: function () {
                ...
                this.uniforms = {
                    quad: 0,
                    center: this.center,
                    size: Math.min(.8, 400 / this.minLength),
                    rect: this.getRect(.02)
                }
            },
            comicstrip: function () {
                ...
                this.uniforms.comicstrip = {
                    center: this.center,
                    size: Math.min(.8, 500 / this.minLength),
                    rect: this.getRect(this.isSquare ? .028 : 0)
                };
                this.uniforms.comicstripwide = {
                    wide: this.isSquare ? 0 : 1,
                    square: this.isSquare ? 1 : 0
                };
                this.uniforms.comicstripsquare = {
                    wide: this.isSquare ? 0 : 1,
                    square: 1
                };
                this.uniforms.comicstripportrait = {
                    wide: 0,
                    square: 0
                };
                this.uniforms.comicstripborder = {
                    rect: this.getRect(.018),
                    border: [.009 * this.minLength / this.maxLength, .009],
                    wide: (this.maxLength - this.minLength / 2) / this.maxLength
                };
                this.uniforms.comicstripborderportrait = {
                    rect: this.getRect(.018),
                    border: [.009, .009 * this.minLength / this.maxLength],
                    wide: .5
                }
            },
            danger: function () {
                this.uniforms = {
                    center: this.center,
                    radius: this.maxLength * .75,
                    rect: this.getRect(.05),
                    fade: 32,
                    stripe: [.5, 2 / 3]
                }
            },
            ...
            disco: function () {
                ...
                this.uniforms = {
                    discolights: {},
                    discored: [new e(3.3, 2.9, .3, .3), new e(1.9, 2, .4, .4), new e(.8, .7, .4, .5), new e(2.3, .1, .6, .3), new e(.8, 1.7, .5, .4), new e(.3, 1, .4, .4), new e(1.4, 1.7, .4, .5), new e(1.3, 2.1, .6, .3), new e(1.8, 1.7, .5, .4)],
                    discogreen: [new e(1.2, 1.9, .3, .3), new e(.7, 2.7, .4, .4), new e(1.4, .6, .4, .5), new e(2.6, .4, .6, .3), new e(.7, 1.4, .5, .4), new e(.7, 1.7, .4, .4), new e(.8, .5, .4, .5), new e(1.4, .9, .6, .3), new e(.7, 1.3, .5, .4)],
                    discoblue: [new e(3.7, .3, .3, .3), new e(1.9, 1.3, .4, .4), new e(.8, .9, .4, .5), new e(1.2, 1.7, .6, .3), new e(.3, .6, .5, .4), new e(.3, .3, .4, .4), new e(1.4, .8, .4, .5), new e(.2, .6, .6, .3), new e(1.3, .5, .5, .4)]
                }
            },
            envy: function () {
            ...
            kaleidoscope: function () {
                ...
                this.uniforms = {
                    center: this.center,
                    offset: [this.width / 2, this.height * .1]
                }
            },
            lomo: function () {
                this.uniforms = {
            ...
            rainbow: function () {
                ...
                this.uniforms = {
                    rainbow: {
                        size: [this.width, this.isSquare ? this.width : this.minLength],
                        offset: this.isSquare ? .4 : .25
                    },
                    overlay: {
                        rect: this.getRect(0),
                        mult: 1.4,
                    ...
                    rainbowborder: {
                        ...
                        radius: e,
                        border: 1.5,
                        ratio: this.isSquare ? 1 : this.size[0] / this.size[1]
                    }
                }
            },
            retro: function () {
            ...
            ripple: function () {
                this.uniforms = {
                    center: this.center,
                    wavelength: this.minLength / 16,
                    amplitude: this.minLength / 22
                }
            },
            rose: function () {
            ...
            spiral: function () {
                ...
                this.uniforms = {
                    ...
                    center: this.center,
                    za: [i * t, r * t],
                    start: [(this.center[0] * i + this.center[1] * r) * -t, (this.center[1] * i - this.center[0] * r) * t],
                    s: [Math.cos(n), Math.sin(n)]
                }
            },
        ...
        i = {
                        ...
                        for (i = 0; i < 6; i++) {
                            switch (t) {
                                ...
                                case i + 6:
                                    ...
                                    break;
                                case i + 12:
                                    A.drawRect(i / 6, 2 / 6, (i + 1) / 6, .5);
                                    break;
                                case i + 18:
                                    A.drawRect(i / 6, .5, (i + 1) / 6, 4 / 6);
                                    break;
                                case i + 24:
            ...
            oldmovie: function () {
                if (Math.random() < .04) {
                    this.uniforms.noise.jump = Math.random() * .02 + .02
                } else {
                ...
                this.uniforms.dot2[2] = Math.random() < .05 ? this.width * 2 : Math.random() * this.width / 60 + 1;
                ...
                if (Math.random() < .025) {
                    ...
                    e += (Math.random() * this.width * .25 - e) * .05
                }
            ...
            quad: function (e) {
                ...
                this.tempTexture.drawTo(function () {
                    ...
                    switch (A.quadPos) {
                        ...
                        case 4:
                            a.drawRect(.5, t, 1, s);
                            e.uniforms(n ? A.uniforms.comicstripportrait : A.uniforms.comicstripwide).drawRect(.5 - r, t + i, 1 - r, s + i);
                        case 3:
                            a.drawRect(.5, s, 1, 1 - t);
                            e.uniforms(n ? A.uniforms.comicstripportrait : A.uniforms.comicstripsquare).drawRect(.5 - r, s - i, 1 - r, 1 - t - i);
                        case 2:
                            a.drawRect(0, t, .5, o);
                            e.uniforms(n ? A.uniforms.comicstripportrait : A.uniforms.comicstripsquare).drawRect(r, t + i, .5 + r, o + i);
                        case 1:
                            a.drawRect(0, o, .5, 1 - t);
                            e.uniforms(n ? A.uniforms.comicstripportrait : A.uniforms.comicstripwide).drawRect(r, o - i, .5 + r, 1 - t - i)
                    }
                }).use(0);
                if (!this.isSquare) {
                    if (n) {
        ...
        a = {
            snow: function () {
                var e = this.context2D,
                    ...
                    s = A.canvas.width,
                    o = A.canvas.height,
                    a, n, c, h, u, l = Math.max(1200, Math.floor(2400 / x.size.height * r)),
                ...
                while (this.assets.snowflakes.length < l && f) {
                    f--;
                    u = (Math.random() + .2) * r / x.size.height * 10 + 1;
                    this.assets.snowflakes.push(new p(Math.random() * i, 4 - u * 2, u, Math.random() - .5, m))
                }
            ...
            sparkle: function () {
                ...
                do {
                    ...
                    if (a[f + d * s] > 32) {
                        this.assets.sparkles.push(new w(f, d, Math.random() < .05))
                    }
                ...
                for (g = 0; g < this.assets.sparkles.length; g++) {
                    ...
                    if (m.isBig) {
                        ...
                        l = c[(m.x + m.y * s) * 4] + (Math.random() - .5) * 16
                    }
            ...
            underwater: function () {
                var A = this.context2D,
                    ...
                    s, o, a = v && this.size[0] !== this.width ? this.width / this.height : 1;
                A.save();
                try {
    ...
    e.prototype.getPos = function (e) {
        this.pos[0] = Math.cos(this.fx * e) * this.sx + .5;
        this.pos[1] = Math.sin(this.fy * e) * this.sy + .5;
        return this.pos
    };
    ...
    function x(e, A, t, i) {
        ...
        this.shaders = {};
        this.mainUniforms = {
            bleed: v || u.ua.isMac ? 0 : .0025,
            mirror: 1,
            upsideDown: v && window.orientation === 180 ? 1 : 0,
            mult: 1,
            offset: 0
        };
        this.isMirror = true;
    ...
    x.autoEnhance = function (e) {
        ...
        while (r--) {
            o[.5 + n[s -= 4] * .3 + n[s + 1] * .59 + n[s + 2] * .11 | 0]++
        }
        for (c = 2; c < 254; c++) {
            if (o[c] < 8) {
                o[c] = 0
            }
            o[c] = o[c - 2] * .1 + o[c - 1] * .2 + o[c] * .4 + o[c + 1] * .2 + o[c + 2] + .1;
            if (o[c] < 8) {
                o[c] = 0
            }
        }
        ...
        l += (E(o) - l) / 8;
        return {
            mult: Math.min(2.5, 253 / (l - h)),
            offset: Math.min(60, h - 2) / -255
        }
    };
...
WebcamToy.Effect.glsl = {
    ...
    _main: "uniform sampler2D texture;varying vec2 texCoord;uniform float bleed;uniform float mirror;uniform float upsideDown;uniform float mult;uniform float offset;void main(){vec2 p=texCoord*(bleed*2.0+1.0)-bleed;if(mirror==1.0){p.x=1.0-p.x;}if(upsideDown==1.0){p=1.0-p;}gl_FragColor=vec4(clamp(texture2D(texture,p).rgb*mult+offset,0.0,1.0),1.0);}",
    ...
    mirrorquad: "void main(){vec2 p=texCoord*2.0;float offset=square==1.0?(texSize.x-texSize.y)/4.0/texSize.x:0.0;p.x=texCoord.x>0.5?(texCoord.x-0.5+offset)*2.0:1.0-p.x+offset*2.0;if(texCoord.y>0.5) p.y=1.0-(texCoord.y-0.5)*2.0;gl_FragColor=texture2D(texture,p);}",
    ...
    mono: "uniform float quad;uniform float fade;uniform vec4 rect;void main(){vec2 p=texCoord;float bc=0.0;if(quad==1.0){if(square==1.0){p.x*=texSize.y/texSize.x;p.x+=(texSize.x-texSize.y)/texSize.x*0.5;}if(p.x<rect.t) bc=(rect.t-p.x)*fade;else if(p.x>rect.q) bc=(p.x-rect.q)*fade;if(p.y<rect.s) bc+=(rect.s-p.y)*fade;else if(p.y>rect.p) bc+=(p.y-rect.p)*fade;p=p*1.03-0.015;}vec3 c=(texture2D(texture,p).rgb-0.5)*2.0+0.75;gl_FragColor=vec4(vec3(c.r*0.3+c.g*0.59+c.b*0.11)-bc,1.0);}",
    neon: "const vec3 cyan=vec3(0.35,1.05,1.4);const vec3 magenta=vec3(1.2,0,0.6);const vec3 yellow=vec3(1.2,1.2,0);void main(){vec2 p=texCoord*2.0;int mode=0;float offset=square==1.0?(texSize.x-texSize.y)/4.0/texSize.x:0.0;if(texCoord.x>0.5){p.x=(texCoord.x-0.5+offset)*2.0;mode++;}else p.x-=offset*2.0;if(texCoord.y>0.5){p.y=(texCoord.y-0.5)*2.0;mode+=2;}vec3 c=texture2D(texture,p).rgb;c=vec3((c.r*0.3+c.g*0.59+c.b*0.11)*1.3);if(mode==0) c*=yellow;else if(mode==2) c*=cyan;else if(mode==3) c*=magenta;gl_FragColor=vec4(c,1.0);}",
    nightvision: "uniform vec2 center;uniform float radius;void main(){float r=texture2D(texture,texCoord).r*0.9,dist=distance(texSize*texCoord,center),attn=1.0-smoothstep(radius,radius*2.0,dist);if(r>0.5) r=1.0-r;r=((r-0.5)*1.25+0.55)*attn;gl_FragColor=vec4(r*0.1,r*1.75,r*0.75,1.0);}",
    oldmoviedirt: "uniform float line;uniform vec3 dot0;uniform vec3 dot1;uniform vec3 dot2;const vec3 black=vec3(0.1);vec3 drawDot(vec3 c,vec3 d){vec2 p=texCoord*texSize-d.xy;return mix(black,c,smoothstep(d.z*0.5,d.z,dot(p,p)));}void main(){if(floor(texCoord.x*texSize.x)==floor(line)) gl_FragColor=vec4(black,1.0);else{vec3 c=drawDot(texture2D(texture,texCoord).rgb,dot0);c=drawDot(c,dot1);gl_FragColor=vec4(drawDot(c,dot2),1.0);}}",
    oldmovienoise: "uniform float flicker;uniform float jump;float rand(vec2 r){return clamp(fract(sin(dot(r,vec2(12.9898,78.233)))*437.5),0.0,1.0);}void main(){vec2 p=texCoord;p.y-=jump;if(p.y<0.0) gl_FragColor=vec4(0.1,0.1,0.1,1.0);else gl_FragColor=texture2D(texture,p)-(rand(vec2(texture2D(texture,p*0.5).g,atan(p.x,p.y)))-flicker)*0.05;}",
    ...
    trail: "uniform sampler2D texture2;void main(){vec3 c1=texture2D(texture,texCoord).rgb,c2=texture2D(texture2,texCoord).rgb,c3=1.0-step(c1-c2,vec3(0.0));float c=min(1.0,c3.r+c3.g+c3.b);gl_FragColor=vec4((step(c-0.02,vec3(0.0))+0.02)*c1+c*c2,1.0);}",
    trueblue: "const vec3 rgbToI=vec3(0.595716,-0.274453,-0.321263);const vec3 rgbToQ=vec3(0.211456,-0.522591,0.311135);void main(){vec3 c=(texture2D(texture,texCoord).rgb-0.5)*1.25+0.6;float hue=atan(dot(c,rgbToQ),dot(c,rgbToI));float lu=c.r*0.3+c.g*0.59+c.b*0.11;if(abs(hue)<2.7) c=vec3(lu);gl_FragColor=vec4(c,1.0);}",
    tunnel: "uniform vec2 center;uniform float radius;void main(){vec2 coord=texCoord*texSize,p=coord-center;float dist=length(p),scale=radius/dist;vec2 r=mat2(scale,0.0,0.0,scale)*p;if(dist<radius) r=coord;else r+=center;gl_FragColor=texture2D(texture,r/texSize);}",
    twist: "uniform vec2 center;uniform float radius;uniform float angle;void main(){vec2 p=texCoord*texSize-center;float dist=length(p);if(dist<radius){float percent=(radius-dist)/radius,theta=percent*percent*angle,s=sin(theta),c=cos(theta);p=vec2(p.x*c-p.y*s,p.x*s+p.y*c);}gl_FragColor=texture2D(texture,(p+center)/texSize);}",
    underwater: "#define PI 3.14159265\n#define WAVELENGTH 5.0\n#define AMPLITUDE 0.025\n#define SPEED 0.6\nuniform float time;const vec3 water=vec3(0.85,1.2,1.6);const vec3 grey=vec3(0.3,0.59,0.11);vec3 mod289(vec3 x){return x-floor(x*(1.0/289.0))*289.0;}vec4 mod289(vec4 x){return x-floor(x*(1.0/289.0))*289.0;}vec4 permute(vec4 x){return mod289(((x*34.0)+1.0)*x);}vec4 taylorInvSqrt(vec4 r){return 1.79284291400159-0.85373472095314*r;}vec3 fade(vec3 t){return t*t*t*(t*(t*6.0-15.0)+10.0);}float noise(vec3 P){vec3 Pi0=floor(P),Pi1=Pi0+vec3(1.0);Pi0=mod289(Pi0);Pi1=mod289(Pi1);vec3 Pf0=fract(P),Pf1=Pf0-vec3(1.0);vec4 ix=vec4(Pi0.x,Pi1.x,Pi0.x,Pi1.x),iy=vec4(Pi0.yy,Pi1.yy),iz0=Pi0.zzzz,iz1=Pi1.zzzz,ixy=permute(permute(ix)+iy),ixy0=permute(ixy+iz0),ixy1=permute(ixy+iz1),gx0=ixy0*(1.0/7.0),gy0=fract(floor(gx0)*(1.0/7.0))-0.5;gx0=fract(gx0);vec4 gz0=vec4(0.5)-abs(gx0)-abs(gy0),sz0=step(gz0,vec4(0.0));gx0-=sz0*(step(0.0,gx0)-0.5);gy0-=sz0*(step(0.0,gy0)-0.5);vec4 gx1=ixy1*(1.0/7.0),gy1=fract(floor(gx1)*(1.0/7.0))-0.5;gx1=fract(gx1);vec4 gz1=vec4(0.5)-abs(gx1)-abs(gy1),sz1=step(gz1,vec4(0.0));gx1-=sz1*(step(0.0,gx1)-0.5);gy1-=sz1*(step(0.0,gy1)-0.5);vec3 g000=vec3(gx0.x,gy0.x,gz0.x),g100=vec3(gx0.y,gy0.y,gz0.y),g010=vec3(gx0.z,gy0.z,gz0.z),g110=vec3(gx0.w,gy0.w,gz0.w),g001=vec3(gx1.x,gy1.x,gz1.x),g101=vec3(gx1.y,gy1.y,gz1.y),g011=vec3(gx1.z,gy1.z,gz1.z),g111=vec3(gx1.w,gy1.w,gz1.w);vec4 norm0=taylorInvSqrt(vec4(dot(g000,g000),dot(g010,g010),dot(g100,g100),dot(g110,g110)));g000*=norm0.x;g010*=norm0.y;g100*=norm0.z;g110*=norm0.w;vec4 norm1=taylorInvSqrt(vec4(dot(g001,g001),dot(g011,g011),dot(g101,g101),dot(g111,g111)));g001*=norm1.x;g011*=norm1.y;g101*=norm1.z;g111*=norm1.w;float n000=dot(g000,Pf0),n100=dot(g100,vec3(Pf1.x,Pf0.yz)),n010=dot(g010,vec3(Pf0.x,Pf1.y,Pf0.z)),n110=dot(g110,vec3(Pf1.xy,Pf0.z)),n001=dot(g001,vec3(Pf0.xy,Pf1.z)),n101=dot(g101,vec3(Pf1.x,Pf0.y,Pf1.z)),n011=dot(g011,vec3(Pf0.x,Pf1.yz)),n111=dot(g111,Pf1);vec3 fade_xyz=fade(Pf0);vec4 n_z=mix(vec4(n000,n100,n010,n110),vec4(n001,n101,n011,n111),fade_xyz.z);vec2 n_yz=mix(n_z.xy,n_z.zw,fade_xyz.y);return mix(n_yz.x,n_yz.y,fade_xyz.x);}void main(){vec2 n=vec2(noise(vec3(texCoord,time*SPEED)*WAVELENGTH)*PI*AMPLITUDE,noise(vec3(texCoord,(time+1.0)*SPEED)*WAVELENGTH)*PI*AMPLITUDE);gl_FragColor=vec4(texture2D(texture,texCoord*0.95+0.025+sin(n)).rgb,1.0);}",
    underwaterblue: "uniform vec2 center;uniform float radius;uniform float width;const vec3 water=vec3(0.85,1.2,1.6);const vec3 grey=vec3(0.3,0.59,0.11);void main(){float dist=distance(texSize*texCoord,center),attn=1.0-smoothstep(radius,radius+width,dist);gl_FragColor=vec4(dot(texture2D(texture,texCoord).rgb,grey*attn)*water,1.0);}",
    upsidedown: "void main(){vec2 p=texCoord;p.y=1.0-p.y;gl_FragColor=texture2D(texture,p);}",
    vintage: "uniform sampler2D texture2;uniform vec2 center;uniform float radius;uniform float width;uniform float rotate;const vec3 tint=vec3(0.56,0.4,0.4);const vec3 vintage=vec3(0.94,0.76,0.6);void main(){vec3 c=texture2D(texture,texCoord).rgb;float dist=distance(texSize*texCoord,center),attn=smoothstep(radius,radius+width,dist);c=min((vec3(c.r*0.3+c.g*0.59+c.b*0.11)+attn)*vintage*1.2,vintage);c+=tint*(1.0-c);vec3 b=texture2D(texture2,rotate==1.0?texCoord.yx:texCoord).rgb;gl_FragColor=vec4(c*b,1.0);}",
    watercolor: "uniform sampler2D texture2;uniform float fade;uniform vec4 rect;const vec3 g1=vec3(0.87,0.35,0.47);const vec3 g2=vec3(0.51,0.41,0.63);void main(){vec2 p=texCoord;vec3 c=(texture2D(texture,p*1.025-0.0125).rgb-0.5)*2.0+0.7;float bc=0.0;if(p.x<rect.t) bc=(rect.t-p.x)*fade;else if(p.x>rect.q) bc=(p.x-rect.q)*fade;if(p.y<rect.s) bc+=(rect.s-p.y)*fade;else if(p.y>rect.p) bc+=(p.y-rect.p)*fade;float lu=c.r*0.3+c.g*0.59+c.b*0.11+bc;if(lu<0.25) c=mix(g1,g2,p.y);else if(lu<0.75) c=mix(g2,g1,p.y)+0.25;else c=vec3(1.0);gl_FragColor=vec4(c*texture2D(texture2,p).rgb,1.0);}",
    wedge: "uniform vec2 center;void main(){vec2 p=texCoord*texSize-center;float w=square==1.0?center.y:center.x,u=p.x/w,v=p.y/center.y,a=atan(v,u);u=cos(a)*u*u*w;v=sin(a)*v*v*center.y;gl_FragColor=texture2D(texture,vec2(center.x+u,center.y+v)/texSize);}",
    ...
    xproborder: "uniform float fade;uniform vec4 rect;void main(){vec3 c=texture2D(texture,texCoord).rgb;float bc=0.0;if(texCoord.x<rect.t) bc=(rect.t-texCoord.x)*fade;else if(texCoord.x>rect.q) bc=(texCoord.x-rect.q)*fade;if(texCoord.y<rect.s) bc+=(rect.s-texCoord.y)*fade;else if(texCoord.y>rect.p) bc+=(texCoord.y-rect.p)*fade;gl_FragColor=vec4(c-clamp(bc,0.0,1.0),1.0);}",
...
WebcamToy.UI = function (o) {
    ...
    var A = {},
        ...
        ke = $("#photo>img"),
        Ue = $("#photo form"),
        Ie = $('#photo input[type="text"]'),
        De = Ie[0],
        Be = De && Ie.data("alt").split("|"),
        Fe = $("#photo p"),
    ...
    function Qe() {
        ...
        if (c.isGrid && S) {
            ...
            S.stop(true, false).each(function () {
                ...
                $(this).css({
                    "margin-left": u.isSquare ? r((e - 2 - e * t) / 2) : 0,
                    width: r(e * t),
                    height: r(e)
            ...
            if (e / i > (A ? 1 : f)) {
                v.css({
                    width: A ? i - 2 : i * t,
                    height: i,
                    "margin-left": A ? (i - 2) / -2 : i * t / -2,
                    "margin-top": i / -2
                });
                w.css({
                    width: i * t,
                    height: i,
                    "margin-left": A ? (i - i * t - 2) / 2 : 0
                })
            } else {
                v.css({
                    width: e,
                    height: A ? e : e / t,
                    "margin-left": e / -2,
                    "margin-top": A ? e / -2 : e / t / -2
                });
                w.css({
                    width: A ? e * t : e,
                    height: A ? e : e / t,
                    "margin-left": A ? (e - e * t) / 2 : 0
                })
            }
            if (u) {
    ...
    function Xe() {
        var e, A, t = S.parent().eq(u.effectNum - l.page * l.effects.length);
        if (!t.length) {
            t = S.parent().eq(4)
        }
        if (!t.length) {
    ...
    function _e() {
        ...
        if (c.isGrid) {
            ...
            setTimeout(function () {
                ...
                setTimeout(function () {
                    v.css({
                        width: e.width,
                        height: e.height,
                        "margin-left": e.left - p.width() / 2,
                        "margin-top": e.top - p.height() / 2
                    });
                    w.css({
                        width: u.isSquare ? e.width * f : e.width,
                        height: e.height,
                        "margin-left": u.isSquare ? (e.width - e.width * f) / 2 : 0
                    });
            ...
            var t = {
                width: v.width(),
                height: v.height(),
                "margin-left": v.css("margin-left"),
                "margin-top": v.css("margin-top")
            };
            v.show().css({
                opacity: 1,
                width: e.width,
            ...
            setTimeout(function () {
                ...
                w.addClass("toy-zoom-in").css({
                    width: u.isSquare ? t.width * f : t.width,
                    height: t.height,
                    "margin-left": u.isSquare ? (t.width - t.width * f - 2) / 2 : 0
                });
                setTimeout(function () {
                    b.hide();
        ...
        if (c.isGridLoaded) {
            ...
            setTimeout(function () {
                ...
                if (l) {
                    o.log("Grid init");
                    setTimeout(function () {
                        l.initPages(l.totalPages, function (e) {
    ...
    function oA() {
        ...
        ke.fadeOut(100, function () {
            Re.hide().css({
                opacity: 1
            }).removeClass("ad ad-hidden photo-bottom photo-tweet");
            ke.removeClass("rotate-two photo-drop photo-img-tweet photo-shadow").attr("src", "")
        });
        Le(0, $("#toy-share-ui"), 0, function () {
    ...
    function aA() {
        if (c.countdown) {
            ...
            re.css({
                ...
                top: A + "%",
                visibility: "visible"
            }).html(c.countdown--).show().delay(e ? 300 : 400).fadeOut(e ? 75 : 100);
    ...
    function hA() {
        c.photoTextNum = Math.floor(Math.random() * Be.length);
    ...
    function uA() {
        if (c.quadCountdown) {
            ...
            if (c.useCameraFlash) {
                $("#camera-flash").show().delay(250).fadeOut(200, function () {
                    c.isCapturing = false;
                    lA()
                })
            } else {
        ...
        setTimeout(function () {
            ...
            switch (u.id) {
                ...
                case "xpro":
                case "zinc":
                    ke.removeClass("photo-white photo-thick");
                    ke.addClass("photo-black photo-thin");
                    break;
                case "disco":
                case "fire":
                case "lsd":
                ...
                case "monoquad":
                case "nightvision":
                    ke.removeClass("photo-white photo-thin");
                    ke.addClass("photo-black photo-thick");
                    break;
                case "cocktail":
                case "comicbook":
                case "comicstrip":
                ...
                case "magazine":
                case "rainbow":
                    ke.removeClass("photo-black photo-thick");
                    ke.addClass("photo-white photo-thin");
                    break;
                case "glaze":
                case "watercolor":
                    ke.removeClass("photo-black photo-thick photo-thin");
                    break;
                default:
                    ke.removeClass("photo-black photo-thin");
                    ke.addClass("photo-white photo-thick")
            }
        ...
        setTimeout(function () {
            ...
            ke.show().css("margin-top", -60);
            setTimeout(function () {
                if (c.shareService !== o.Services.ID.TWITTER) {
                    ke.addClass("rotate-two photo-drop")
                }
                ke.css("margin-top", 0);
                Te++;
                Te %= 2;
                if (Te === 0 && c.shareService !== o.Services.ID.TWITTER) {
                    Re.addClass("ad");
                    Re.removeClass("ad-hidden")
                } else {
                    Re.removeClass("ad");
                    Re.addClass("ad-hidden")
                }
                setTimeout(function () {
                    ke.addClass("photo-shadow");
    ...
    function dA(e) {
        e = e.replace(/(^|[-\u2014\s(\["])'/g, "$1â€˜");
        e = e.replace(/'/g, "â€™");
        e = e.replace(/(^|[-\u2014\[(\u2018\s])"/g, "$1â€œ");
        e = e.replace(/"/g, "â€");
        e = e.replace(/<3/g, "â¤ï¸");
        e = e.replace(/\.\.\./g, "â€¦");
        e = e.replace(/(:\)|:\-\)|\=\)|\(:)/g, "ðŸ˜Š");
        e = e.replace(/:D|\=D|:3/g, "ðŸ˜");
        e = e.replace(/;\)/g, "ðŸ˜‰");
        e = e.replace(/(:\(|:\-\(|\=\()/g, "ðŸ™");
    ...
    function kA() {
        ...
        o.Services.twitterPost({
            image: n,
            message: dA(Ie.val()) || mA()
        }, RA, TA)
    }
    ...
    function IA() {
        var e = dA(Ie.val());
        if (Ie.val() !== e) {
            var A = De.selectionStart + e.length - Ie.val().length + 1;
            De.focus();
            Ie.val("");
            Ie.val(e);
            if (De.setSelectionRange && A) {
                De.setSelectionRange(A, A)
            }
        }
        var t = m - e.length;
        Fe.text(t).removeClass("short long blur").addClass(Ie.is(":focus") ? t < 20 ? "short" : "long" : "blur")
    }

    function DA() {
        if (Ue.is(":visible")) {
            Le(0, Ue, 100, function () {
                ke.addClass("rotate-two");
                Re.removeClass("photo-bottom");
                De.blur();
                Ie.val("")
            }, true)
        }
    ...
    function BA() {
        ke.removeClass("rotate-two photo-drop").addClass("photo-img-tweet");
        Re.removeClass("ad").addClass("photo-bottom photo-tweet ad-hidden");
        Ie.attr("placeholder", mA());
        De.disabled = false;
        Ue.css("opacity", 0);
        Le(1, Ue, 100, function () {
            De.focus();
            IA()
        }, true);
    ...
    function et(e) {
        ze();
        o.Camera.getCamera(function (e, A, t) {
            if (t) {
                o.error(t, A);
                return
            }
    ...
    function At() {
        ...
        S.parent().each(function (A) {
            $(this).on("mousedown touchstart", function (e) {
                ...
                $(this).data("pressed", true).css({
                    width: s - (u.isSquare ? 2 : 0),
                    height: r
                }).animate({
                    "margin-left": o((s - (s - (u.isSquare ? 2 : 0)) * t) / 2),
                    "margin-bottom": o((r - r * t) / 2),
                    width: (s - (u.isSquare ? 2 : 0)) * t,
                    height: r * t
                }, 100, "easeOutQuad");
                i.css({
                    width: r * A,
                    ...
                    "margin-left": u.isSquare ? o((r - r * A) * t / 2) : 0,
                    width: r * A * t,
                    height: r * t
                }, 100, "easeOutQuad")
        ...
        }).mouseup(sA).mouseout(sA).mouseleave(sA);
        if (!a) {
            z.hover(function () {
                $A(ae);
    ...
    function tt() {
        Ie.on("change input focus blur mousedown mouseup", IA);
    ...
    function ct() {
        ...
        F[0].checked = c.useCameraFlash;
        J[0].checked = tA();
        $(document).on("webkitfullscreenchange mozfullscreenchange mozfullscreenerror", function () {
            J[0].checked = tA();
            Qe()
...
WebcamToy.Home = function (i) {
    ...
    function h(e, A) {
        if (e && A && A.img && A.id) {
            ...
            e.attr("href", "https://pic.twitter.com/" + A.id)
        }
    }
    ...
    e.init = function () {
        ...
        $("header a,#home-photos a,#home-body a,#home footer a,#toy-intro a").click(function (e) {
            i.trackEvent("Outbound", e.target.href || e.currentTarget.href)
        });
        $("#home-photos a").click(function (e) {
            i.popup(e, e.target.href || e.currentTarget.href, Math.min(screen.availWidth, 703), Math.min(screen.availHeight - 100, 660), "photowindow")
        });
        d()
    };
    return e
